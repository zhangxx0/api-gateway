package com.xinxin.apigateway.configuration;
...
public class GatewayConfiguration {
    ...
    /**
     * 'sentinelGatewayFilter', defined in class path resource [com/alibaba/cloud/sentinel/gateway/scg/SentinelSCGAutoConfiguration.class], could not be registered
     * 原名：sentinelGatewayFilter ，启动时报以上错，我给改名为sentinelGatewayFilter2后不报错，可正常启动；
     */
    @Bean
    @Order(-1)
